...
namespace Uptime
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationDbContext>(x => x.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("Uptime")));
            ...
            services.AddScoped<RouteInfoService, RouteInfoService>();
